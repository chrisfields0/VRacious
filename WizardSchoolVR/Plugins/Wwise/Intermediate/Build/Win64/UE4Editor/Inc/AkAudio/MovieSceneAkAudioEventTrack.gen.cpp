...
// End Cross Module References
	...
	UClass* Z_Construct_UClass_UMovieSceneAkAudioEventTrack()
	{
		...
		if (!OuterClass)
		{
			...
			if (!(OuterClass->ClassFlags & CLASS_Constructed))
			{
				...
				static TCppClassTypeInfo<TCppClassTypeTraits<UMovieSceneAkAudioEventTrack> > StaticCppClassTypeInfo;
	...
	IMPLEMENT_CLASS(UMovieSceneAkAudioEventTrack, 602167410);
