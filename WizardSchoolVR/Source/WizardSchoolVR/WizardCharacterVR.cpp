...
//	staticConstructorHelpers::FObjectFinder<USkeletalMeshComponent> S(TEXT(TEXT("SkeletalMesh'/Game/VirtualReality/Mannequin/Character/Mesh/MannequinHand_Right.MannequinHand_Right'"));
